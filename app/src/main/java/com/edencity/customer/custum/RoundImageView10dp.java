...
public class RoundImageView10dp extends AppCompatImageView {
    float width,height;
    private int mRadiusPx;

    public RoundImageView10dp(Context context) {
        this(context, null);
    }

    public RoundImageView10dp(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundImageView10dp(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
